#define NGX_CONFIGURE " --prefix=/usr/local/nginx --add-module=/home/zhangyc/cloud_storage/lib/fastdfs-nginx-module-1.22/src --with-http_ssl_module --with-stream --with-cc-opt=-Wno-format-truncation"
